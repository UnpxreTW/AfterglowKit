...
public enum ArticleCommentScanner {
	...
	///
	/// - Warning: 這條判準在兩個方向上會判不準，兩者的爆炸半徑都是整篇、不是單則。①一篇只有一則
	...
	///
	/// - Warning: 那種暱稱若含空白會被這一關擋掉、含冒號則會讓切點落在暱稱裡（切的是第一個冒號）。
